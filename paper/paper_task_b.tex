...
Relevance (MMR) pass for diversity and a synthetic
...
\begin{figure}[t]
  ...
  \caption{Blind human relevance: raters score Claude's recommendation lists
  as more contextually relevant than NaijaReviewer-8B's (mean 3.40 vs 2.60;
  NaijaReviewer-8B win-rate 27.3\,\%), the reverse of the automatic NDCG@10
  ranking. We report the divergence rather than hide it.}
...
step for the recommendation engine.
